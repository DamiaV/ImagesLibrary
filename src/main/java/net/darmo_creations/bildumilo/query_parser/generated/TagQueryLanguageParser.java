...
public class TagQueryLanguageParser extends Parser {
	...
	public static class QueryContext extends ParserRuleContext {
		public TerminalNode EOF() { return getToken(TagQueryLanguageParser.EOF, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode STAR() { return getToken(TagQueryLanguageParser.STAR, 0); }
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TagQueryLanguageVisitor ) return ((TagQueryLanguageVisitor<? extends T>)visitor).visitQuery(this);
	...
	public static class OrContext extends ExprContext {
		...
		public TerminalNode OR() { return getToken(TagQueryLanguageParser.OR, 0); }
		public List<TerminalNode> WS() { return getTokens(TagQueryLanguageParser.WS); }
		public TerminalNode WS(int i) {
			return getToken(TagQueryLanguageParser.WS, i);
		}
	...
	public static class NegationContext extends ExprContext {
		public TerminalNode NOT() { return getToken(TagQueryLanguageParser.NOT, 0); }
		public LitContext lit() {
			return getRuleContext(LitContext.class,0);
		}
		public TerminalNode WS() { return getToken(TagQueryLanguageParser.WS, 0); }
	...
	public static class GroupContext extends LitContext {
		public TerminalNode LPAREN() { return getToken(TagQueryLanguageParser.LPAREN, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode RPAREN() { return getToken(TagQueryLanguageParser.RPAREN, 0); }
		public List<TerminalNode> WS() { return getTokens(TagQueryLanguageParser.WS); }
		public TerminalNode WS(int i) {
			return getToken(TagQueryLanguageParser.WS, i);
		}
	...
	public static class PseudoTagRegexContext extends LitContext {
		public List<TerminalNode> IDENT() { return getTokens(TagQueryLanguageParser.IDENT); }
		public TerminalNode IDENT(int i) {
			return getToken(TagQueryLanguageParser.IDENT, i);
		}
		public TerminalNode EQUAL() { return getToken(TagQueryLanguageParser.EQUAL, 0); }
	...
	public static class BooleanPseudoTagContext extends LitContext {
		public TerminalNode HASH() { return getToken(TagQueryLanguageParser.HASH, 0); }
		public TerminalNode IDENT() { return getToken(TagQueryLanguageParser.IDENT, 0); }
		public BooleanPseudoTagContext(LitContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TagQueryLanguageVisitor ) return ((TagQueryLanguageVisitor<? extends T>)visitor).visitBooleanPseudoTag(this);
			else return visitor.visitChildren(this);
		}
	}
